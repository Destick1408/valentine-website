...
const CONFIG = {
    ...
    questions: {
        ...
        third: {
            text: "¿Quieres ser mi San Valentin el 14 de febrero de 2026? 🌹", // The big question!
            yesBtn: "Si!",                                              // Text for "Yes" button
            noBtn: "No"                                                 // Text for "No" button
        }
    },
    ...
    loveMessages: {
        ...
        normal: "Y mas alla! 🥰"                           // Shows when they go past 100%
    },

    // Messages that appear after they say "Yes!"
    celebration: {
        title: "Yay! Soy la persona mas afortunada del mundo! 🎉💝💖💝💓",
        message: "Ahora ven por tu regalo: un abrazo calientito y un beso enorme!",
    ...
    music: {
        ...
        musicUrl: "drake.mp3", // Music streaming URL
        startText: "🎵 Reproducir musica",  // Button text to start music
        stopText: "🔇 Detener musica",      // Button text to stop music
